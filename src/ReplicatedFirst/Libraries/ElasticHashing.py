# Forked from https://github.com/MWARDUNI/ElasticHashing
...
class ElasticHashTable:
    ...
    def _probe_sequence(self, key, i):
        ...
        return [random.randint(0, self.n - 1) for _ in range(10)]  # Probe limit TODO: change 10 to depend on n as in the paper
